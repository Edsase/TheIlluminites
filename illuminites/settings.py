...
"""
Django settings for illuminites project.
...
ROOT_URLCONF = 'illuminites.urls'



WSGI_APPLICATION = 'illuminites.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'illuminites', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'illuminites', 'templates'),],
        'OPTIONS': {
            'context_processors': [
